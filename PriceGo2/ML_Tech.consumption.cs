...
namespace PriceGo2
{
    ...
    //        if (File.Exists(CopyFileToAppData(FileName)))
    //        {
    //            string fileContent = await File.ReadAllTextAsync(CopyFileToAppData(FileName));
    //            return fileContent;
    ...
    //    }
    //}
    public partial class ML_Tech
    {
        /// <summary>
        /// model input class for ML_Tech.
        /// </summary>
        ...
        /// <summary>
        /// model output class for ML_Tech.
        /// </summary>
        ...
        public static string MLNetModelPath = Path.GetFullPath("ML_Tech.mlnet");
